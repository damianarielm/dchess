...
endGamePawnPositionWhite = tuple(reversed(endGamePawnPosition))
endGamePawnPositionBlack = tuple(reversed(endGamePawnPositionWhite))
...
endGameKnightPositionWhite = tuple(reversed(endGameKnightPosition))
endGameKnightPositionBlack = tuple(reversed(endGameKnightPositionWhite))
...
endGameBishopPositionWhite = tuple(reversed(endGameBishopPosition))
endGameBishopPositionBlack = tuple(reversed(endGameBishopPositionWhite))
...
endGameRookPositionWhite = tuple(reversed(endGameRookPosition))
endGameRookPositionBlack = tuple(reversed(endGameRookPositionWhite))
...
endGameQueenPositionWhite = tuple(reversed(endGameQueenPosition))
endGameQueenPositionBlack = tuple(reversed(endGameQueenPositionWhite))
